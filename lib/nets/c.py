...
class Network(object):
    ...
    def _build_network(self, is_training=True):
        ...
        with tf.variable_scope('fusion'):
            wo = tf.get_variable('wo', (cfg.OBJECT_SIZE+cfg.QUES_SIZE, cfg.LSTM_SIZE), initializer=self.initializer, regularizer=self.weights_regularizer)
            ...
            fusion = tf.add(tf.matmul(tf.reshape(qo_co_atten, (-1, cfg.OBJECT_SIZE+cfg.QUES_SIZE)), wo),
