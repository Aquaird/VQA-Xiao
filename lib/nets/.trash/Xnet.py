...
class Network(object):
    ...
    def _build_network(self, is_training=True):
        ...
        with tf.variable_scope('final'):
            ...
            # new fc
            #w_add_fc = tf.get_variable('w', [cfg.T_ATTEN_FEATURE_DIM + 2* cfg.LSTM_SIZE, cfg.T_ATTEN_FEATURE_DIM+2*cfg.LSTM_SIZE], initializer=self.initializer)
            #softmax_input = tf.matmul(softmax_input, w_add_fc)
